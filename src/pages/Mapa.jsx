...
export default function Mapa({ onVerHorarios }) {
  ...
  const linhasFiltradas = LINHAS.filter(l => filtro === "todos" || l.tipoTransporte === filtro);

  function abrirPainel(linha) {
    setLinhaSel(linha);
      ...
      {linhaSel && (
        <div style={s.painel(painelAberto)}>
          ...
          {(() => {
            ...
            const prox  = proximoHorario(linhaSel._id);
            return (
              <>
